...
from HyperLung_XR.entity.config_entity import DataTransformationConfig
...
class DataTransformation:
    ...
    def transforming_val_data(self) -> transforms.Compose:
        logging.info(
            "Entered the transforming_val_data method of Data transformation class"
        )
        ...
        try:
            ...
            logging.info(
                "Exited the transforming_val_data method of Data transformation class"
            )
    ...
    def data_loader(
        self, train_transform: transforms.Compose,val_transform: transforms.Compose, test_transform: transforms.Compose
        ...
        try:
            ...
            logging.info("Created train data,val data and test data paths")
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        try:
            ...
            data_transformation_artifact: DataTransformationArtifact = DataTransformationArtifact(
                ...
                val_transform_file_path=self.data_transformation_config.val_transforms_file,
